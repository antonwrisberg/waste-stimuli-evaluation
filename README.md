...
- **[v0.0.7](https://antonwrisberg.github.io/waste-stimuli-evaluation/dist/experiment/index.html?version=categorisation.0.0.6)**. **Current favourite**. This setups shows participants one waste fraction and one waste item at a time and asks the participant to indicate if they believe the item to belong in the fraction. This setup is prepared for sequential sampling analysis, such as with a drift diffusion model. *Has not been tested on participants yet*.
