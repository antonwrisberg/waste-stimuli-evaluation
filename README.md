...
You can see an overview of the 250 waste items currently in the beta version of the stimuli set [here](dist/experiment/index.html?version=showcase.0.0.1)).
...
- [v0.0.3](dist/experiment/index.html?version=categorisation.0.0.3). Same as v0.0.1 but where only a random subset of four of the waste fractions are shown. The idea behind this was to also infer a bit about prototypicality of items by measuring how often they select other categories when the obvious(ly correct) category is not present. *Has not been tested on participants yet*.
- [v0.0.4](dist/experiment/index.html?version=categorisation.0.0.4). Same as v0.0.3, but asking participants which of the subset of four fractions the item fits the worst into. *Has not been tested on participants yet*.
- [v0.0.5](dist/experiment/index.html?version=categorisation.0.0.5). A variant of v0.0.1 with more text and arrows. Appears "too much" to me. *Has not been tested on participants yet*.
- [v0.0.6](dist/experiment/index.html?version=categorisation.0.0.6). **Not yet uploaded**. A variant of v0.0.1 but with monocolour waste fraction signs. Just here to show how difficult it becomes when you cannot identify the signs by colour (that you learn after a few trials). *Has (and should maybe) not been tested on participants yet*.
