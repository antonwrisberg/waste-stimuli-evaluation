...
- **[v0.0.3](https://antonwrisberg.github.io/waste-stimuli-evaluation/dist/experiment/index.html?version=frequency.0.0.3)**. **Current favourite**. Same as v0.0.2 but with updated text based on Elsa's pilot tests. In this version, the sentence is "In the past week, I have generated waste like this (ignoring brands) __ times".
...
- **[v0.0.3](https://antonwrisberg.github.io/waste-stimuli-evaluation/dist/experiment/index.html?version=prototypicality.0.0.3)**. **Current favourite**. Same as v0.0.2 but with slightly updated text based on Elsa's pilot tests. Most importantly, "household waste" is replaced with "waste from the home".
...
- Frequency v**0.0.3** [ [example](https://antonwrisberg.github.io/waste-stimuli-evaluation/dist/experiment/index.html?version=frequency.0.0.3) &#124; [context](#frequency) ]
- Prototypicality v**0.0.3** [ [example](https://antonwrisberg.github.io/waste-stimuli-evaluation/dist/experiment/index.html?version=prototypicality.0.0.3) &#124; [context](#prototypicality) ]
