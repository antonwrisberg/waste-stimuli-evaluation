...
- **[v0.0.7](https://antonwrisberg.github.io/waste-stimuli-evaluation/dist/experiment/index.html?version=prototypicality.0.0.7)**. **Current favourite**. This setup improves on version 0.0.6 by limiting the answer space to an arrow ranging from "worse" to "better".
