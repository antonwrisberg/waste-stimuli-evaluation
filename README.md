...
- **[v0.0.8](https://antonwrisberg.github.io/waste-stimuli-evaluation/dist/experiment/index.html?version=frequency.0.0.7)**. **Current favourite**. Same as v0.0.7 but with the selection done by clicking the f and j keys instead of clicking the alternatives with a mouse/pointer.
