...
- **[v0.0.4](https://antonwrisberg.github.io/waste-stimuli-evaluation/dist/experiment/index.html?version=prototypicality.0.0.4)**. **Current favourite**. Same as v0.0.3 but with an added prompt forcing participants to write down their mental image and with the middle option in the scale replaced with "← less | more →".
...
- Prototypicality v**0.0.4** [ [example](https://antonwrisberg.github.io/waste-stimuli-evaluation/dist/experiment/index.html?version=prototypicality.0.0.4) &#124; [context](#prototypicality) ]
