...
- **[v0.0.8](https://antonwrisberg.github.io/waste-stimuli-evaluation/dist/experiment/index.html?version=frequency.0.0.8)**. **Current favourite**. Same as v0.0.7 but with the selection done by clicking the f and j keys instead of clicking the alternatives with a mouse/pointer.
...
- **[v0.0.7](https://antonwrisberg.github.io/waste-stimuli-evaluation/dist/experiment/index.html?version=prototypicality.0.0.7)**. **Current favourite**. This setup improves on version 0.0.6 by limiting the answer space to an arrow ranging from "worse" to "better". The current version is merely a mockup of the drag-and-drop functionality and does not allow the participant to move ahead after placing all items on the arrow.
