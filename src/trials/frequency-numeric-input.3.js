    ...
    timeline: [
      {
        ...
        html: function() {
          switch (experiment.detectLanguage()) {
            case 'en':
              return '<p>In the past week, I have expended this (ignoring brands) <input type="number" id="resp-box" name="response" required /> times.</p>';
            case 'da':
              return '<p>I løbet af den seneste uge har jeg forbrugt dette (ignorer varemærker) <input type="number" id="resp-box" name="response" required /> gange.</p>';
            case 'sv':
              return '<p>Under den senaste veckan har jag förbrukat detta (ignorera varumärken) <input type="number" id="resp-box" name="response" required /> gånger.</p>';
            default:
              break;
          }
        },
