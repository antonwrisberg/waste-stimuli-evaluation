    ...
    timeline: [
      {
        ...
        choices: function() {
          switch (experiment.detectLanguage()) {
            case 'en':
              return ["Click here when you have formed a mental image of waste that you would categorise as " + jsPsych.timelineVariable('fraction_en')];
            case 'da':
              return ["Klik her, når du har dannet et mentalt billede af affald, som du ville kategorisere som " + jsPsych.timelineVariable('fraction_da')];
            case 'sv':
              return ["Klicka här när du har skapat en mental bild av avfall som du skulle kategorisera som " + jsPsych.timelineVariable('fraction_sv')];
            default:
              break;
          }
        },
