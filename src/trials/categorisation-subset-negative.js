    ...
    timeline: [
      {
        ...
        img_path: "",
        prompt: "<p>If you have to choose one, which of the waste fractions on the right do you think that the waste item on the left fits <strong>the worst</strong> into?<br /> <br />Click a waste fraction to select it.</p>",
