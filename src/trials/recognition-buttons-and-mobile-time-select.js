  ...
  experiment.timeline.push({
    ...
    stimulus: function() {
      switch (experiment.detectLanguage()) {
        case 'en':
          return `
            <p>Thank you for choosing to participate. In a moment, you will see images of waste.</p>
            <p>For each image, you should decide whether you could explain to someone else what it is.</p>
          `;
        case 'da':
          return `
            <p>Tak for, at du vil være med. Om et øjeblik vil du se billeder af affald.</p>
            <p>For hvert billede, skal du afgøre, om du ville kunne foreklare en anden, hvad det er.</p>
          `;
        case 'sv':
          return `
            <p>Tack för att du vill vara med. Inom kort kommer du att se bilder på avfall.</p>
    ...
    timeline: [
      {
        ...
        prompt: function() {
          switch (experiment.detectLanguage()) {
            case 'en':
              return `<p class="jspsych-html-button-response-prompt">Could you explain to someone else what this is?</p>`;
            case 'da':
              return `<p class="jspsych-html-button-response-prompt">Kunne du forklare en anden, hvad det her er?</p>`;
            case 'sv':
              return `<p class="jspsych-html-button-response-prompt">Kunna du förklara för någon annan vad det här är?</p>`;
            default:
              break;
          }
        },
