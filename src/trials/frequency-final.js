...
export default function (experiment) {
  ...
  experiment.timeline.push({
    type: PreloadPlugin,
    images: [
      "assets/img/screendumps/tinified/part1_sv.png",
      "assets/img/screendumps/tinified/part1.1_sv.png",
      ...
      "assets/img/attention-checks/800x800se/tinified/sällan.png",
      "assets/img/attention-checks/800x800se/tinified/ofta.png"
    ]
  });
      ...
      switch (experiment.detectLanguage()) {
        ...
        case 'sv':
          return `
            ...
            <img src="assets/img/screendumps/tinified/part1_sv.png" class="screendump">

            <p>Din uppgift kommer att vara att sortera bilderna längs pilen efter<br /><b>hur ofta soporna på bilderna förekommer bland dina sopor</b>.</p>
            ...
            <img src="assets/img/screendumps/tinified/part1.1_sv.png" class="screendump">
    ...
    timeline: [
      {
            ...
            case 'sv':
              return `
                ...
                <ol style="text-align: left">
                  <li>Dra apelsinen till pilen <b>som om</b> den ofta förekommer bland dina sopor.</li>
                  <li>Dra målarburken till pilen <b>som om</b> den sällan förekommer bland dina sopor.</li>
                  <li>Dra vinflaskan till pilen <b>som om</b> den förekommer bland dina sopor mer sällan än apelsinen, men oftare än målarburken.</li>
                  <li>Dra makrillburken till pilen <b>som om</b> den förekommer bland dina sopor mer sällan än vinflaskan, men oftare än målarburken.</li>
                </ol>
              `;
            default:
              break;
        ...
        data: {
          question: 'freuqency-line-sort-training-trial'
        },
        on_load: function() {
  ...
  // Actual trials - first one mixed
  experiment.timeline.push({
    timeline: [
      {
        type: CallFunctionPlugin,
        func: function() {
          experiment.stimuli.items.inCurrentTrial = jsPsych.randomization.sampleWithoutReplacement(experiment.stimuli.items.all, experiment.prototypicalityFreeSortCongruentCount + experiment.prototypicalityFreeSortIncongruentCount)
        }
      },
      {
        type: PreloadPlugin,
        ...
        img_array: function() {
          ...
          if (Math.random() > .6) {
            ...
            if (new Date().getSeconds() % 2 == 0) {
              imgArray.push('../attention-checks/800x800se/tinified/ofta.png')
              // console.log("'ofta' attention check")
            } else {
              imgArray.push('../attention-checks/800x800se/tinified/sällan.png')
        ...
        prompt: function() {
          switch (experiment.detectLanguage()) {
            ...
            case 'da':
              return `<p>Træk billederne og placer dem langs pilen efter, <b>hvor ofte du færdigopbruger dem</b>.</p>`;
            case 'sv':
              return `<p>Dra bilderna och placera dem längs pilen enligt <b>hur ofta soporna på bilderna förekommer bland dina sopor</b>.</p>`;
            default:
              break;
          }
        },
  ...
  // Actual trials - then individual fractions
  experiment.timeline.push({
    timeline: [
      {
        type: CallFunctionPlugin,
