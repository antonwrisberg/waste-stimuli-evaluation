            ...
            timeline: [ // Per fraction on mobile view
              {
                ...
                images: function () {
                  ...
                  for (var i = 0; i < experiment.stimuliCounts.congruent; i ++) {
                    preloadPaths.push('assets/img/stimuli-1.2-800x800-sorted/' + thisFraction.congruent[i]);
                  }

                  for (var i = 0; i < experiment.stimuliCounts.incongruent; i ++) {
                    preloadPaths.push('assets/img/stimuli-1.2-800x800-sorted/' + thisFraction.incongruent[i]);
                  }
